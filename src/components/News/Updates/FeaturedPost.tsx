    ...
    <div className="w-full bg-black h-[700px] border-b-[4px] border-[#313131] sm:pt-[77px] flex flex-col-reverse">
      ...
      <div className="w-[72%] mx-auto hover:-translate-y-5 transition-all duration-200 mb-16">
        <div className="flex justify-between font-semibold">
          ...
          <span className="text-xs sm:text-base text-white inline-block bg-[#505050] p-1 px-2 tracking-widest uppercase">
            FEATURED POST
          </span>
        </div>
        <div className="w-[85%]">
          <h2 className="text-[40px] sm:text-[60px] sm:leading-[72px] font-semibold text-white/90">
