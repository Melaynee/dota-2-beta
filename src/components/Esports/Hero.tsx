        ...
        <div className="flex justify-around items-center h-full pl-20 pr-12">
          ...
          <div className="w-[460px]">
            <Image
              ...
              width={866}
              height={574}
              className="w-[460px] mb-6"
            />
            <h4 className="text-white text-[15px] font-semibold text-shadow text-center tracking-[0.2rem]">
              2022-2023 SEASON
            </h4>
          </div>
          <div>
            <h4 className="text-sm tracking-[0.25rem] font-light -mb-1">
              TOTAL PRIZE POOL
            </h4>
