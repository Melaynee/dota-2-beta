  ...
  return (
    <div className="relative">
      <div className="flex flex-col w-[200px] sm:w-[400px] md:w-[600px] lg:w-[800px] xl:w-[1200px] mx-auto">
        <Carousel direction="left" speed={50} data={heroes.slice(0, 34)} />
        <Carousel direction="right" speed={40} data={heroes.slice(34, 68)} />
        <Carousel direction="left" speed={60} data={heroes.slice(68, 102)} />
        <Carousel direction="right" speed={20} data={heroes.slice(102)} />
        <Carousel direction="left" speed={40} data={heroes.slice(20, 54)} />
